$('.incorrectGlobal2').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectGlobal2').each(function () {
...
$('.incorrectCountA').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectCountA').each(function () {
    $(this).data('click', count);
...
$('.incorrectCountB').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectCountB').each(function () {
    $(this).data('click', count);
...
$('.incorrectCountC').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectCountC').each(function () {
    $(this).data('click', count);
...
$('.incorrectCountD').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectCountD').each(function () {
    $(this).data('click', count);
...
$('.incorrectCountE').on('click', function () {
  var count = parseInt($(this).data('click')) || 0;
  count = count + 1;
  $('.incorrectCountE').each(function () {
    $(this).data('click', count);
